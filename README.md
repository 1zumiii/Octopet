...
Claude App里的小章鱼太可爱了，于是乎找 Opus 要了一个一模一样的桌面小宠物，现在分享给大家～

动画是对着 Claude 桌面端里的原版小章鱼逐帧比对复刻的：从兜里摸索、掏出电脑、转身、敲键盘（双手轮流 + 电脑跟着抖），到合上电脑塞回兜里，都尽量还原了。另外加了一点原版没有的待机动画：待机时会轻轻地上下呼吸。
...
| **拖动** | 把它放到屏幕任意位置 |
| **右键** | 调整大小（原版大小 / 大一点 / 超大只 / 巨无霸）、摸鱼模式、开机自动启动、退出 |

- 它会一直浮在其他窗口上面，并且在所有桌面空间都能看到
- 没有 Dock 图标，想关掉的话右键 →「再见小章鱼 👋」
- 开启「摸鱼模式」后，它会自己认真敲代码，工作途中偶尔摸一小会儿鱼（工作 45 秒～3 分钟，摸鱼 8～25 秒，都是随机的）
